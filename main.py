...
ALL_POSSIBLE_COINS = [
    ...
    # Small caps on Kraken
    ("numeraire", "NMR"), ("melon", "MLN"), ("oasis-network", "ROSE"),
    ("moonbeam", "GLMR"), ("moonriver", "MOVR"), ("acala", "ACA"),
    ("karura", "KAR"), ("bifrost-native-coin", "BNC"),
    ("api3", "API3"), ("badger-dao", "BADGER"), ("balancer", "BAL"),
    ("bancor", "BNT"), ("civic", "CVC"), ("district0x", "DNT"),
    ("funtoken", "FUN"), ("gods-unchained", "GODS"),
    ("immutable-x", "IMX"), ("jasmy", "JASMY"), ("keep-network", "KEEP"),
    ("liquity", "LQTY"), ("mina-protocol", "MINA"), ("nkn", "NKN"),
    ("orbs", "ORBS"), ("origin-protocol", "OGN"), ("paid-network", "PAID"),
    ("pax-gold", "PAXG"), ("perpetual-protocol", "PERP"),
    ("power-ledger", "POWR"), ("quant-network", "QNT"),
    ("radix", "XRD"), ("rally-2", "RLY"), ("rarible", "RARI"),
    ("reef", "REEF"), ("request", "REQ"), ("siacoin", "SC"),
    ("smooth-love-potion", "SLP"), ("spell-token", "SPELL"),
    ("superfarm", "SUPER"), ("tornado-cash", "TORN"),
    ("trust-wallet-token", "TWT"), ("uma", "UMA"),
    ("wrapped-nxm", "WNXM"), ("xyo-network", "XYO"),
    ("yield-guild-games", "YGG"), ("zebec-protocol", "ZBC"),
]
...
def discover_verified_pairs():
    ...
    coinbase_available = {
        ...
        "APT","RNDR","FET","AKT","BAND","KAVA","CELO","LRC","STORJ",
        "ANKR","IOTX","SKL","CTSI","GNO","NMR","MLN","ROSE","GLMR",
        "MOVR","API3","BADGER","BAL","BNT","CVC","DNT","FUN","GODS",
        "IMX","JASMY","KEEP","LQTY","MINA","NKN","OGN","PAXG","PERP",
        "POWR","QNT","RARI","REQ","SC","SPELL","SUPER","UMA","YGG",
    }
...
def execute_arb(symbol, buy_ex, sell_ex, buy_price, sell_price, net_pct):
    ...
    if buy_ok and sell_ok:
        ...
        send_telegram(
            ...
            f"Buy {buy_ex}: {'✅' if buy_ok else '❌'}\n"
            f"Sell {sell_ex}: {'✅' if sell_ok else '❌'}\n"
